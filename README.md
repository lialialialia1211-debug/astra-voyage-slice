...
- 目前為第一章垂直切片開發版；新版入口與既有 RPG 系統正處於共存期。
...
- 18 歲以上確認與 v3 本機存檔
- 固定主角昭黎，不再顯示男女艦長選擇
- 唯一正史第1幕〈港鐘與舊情〉、第2幕〈黑船返航〉與三人 AVG 舞台
- 六屬性入門主手與兩人教學戰 B1〈外灣救難線〉
...
- 目前存檔結構為 v3；舊版 v1／v2 會保留成年顯示模式、AP 與安全資源，但舊主線／收藏不會映射成新版正史進度。
- 進行中的舊陸地戰鬥與第一章 B1 都會保存戰鬥快照，重新整理可從最新回合繼續。
